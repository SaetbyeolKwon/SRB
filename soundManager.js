const audioConfig = {
    ...
    "Faster and faster": { id: "theNorthPole", src: "sounds/TheNorthPole.mp3", type: 'bg', loop: true, volume: 0.2 },
    "frozen sea": { id: "thereIsTheNorthPole01", src: "sounds/thereIsTheNorthPole01.m4a", type: 'se', volume: 1.0 },
    "a huge city": { id: "theJoyfulSeason", src: "sounds/The Joyful Season.mp3", type: 'bg', loop: true, bgColor: "#5a6f7f", fadeOutTrigger: "choose one of you", volume: 0.2 },
    ...
    "Express could go no": { id: "steam01", src: "sounds/steam01.m4a", type: 'se', volume: 1.0 },
    "pressed through the": { id: "christmasEve", src: "sounds/Christmas Eve.mp3", snowflake: true, type: 'bg', loop: true, volume: 0.2 },
    "handed me up": { id: "christmasEve", src: "sounds/Christmas Eve.mp3", type: 'bg', loop: true, volume: 0.2 },
};
